// =============================================
// WazgAccessibility.js - Live Contrast Monitor
// =============================================
...
window.WazgAccessibility = {
  ...
  init: function() {
    ...
    if (window.WazgLogcat) {
      window.WazgLogcat.log("ACCESS", "Live Contrast Monitor initialized");
    }
    this.runFullCheck();
  },
  ...
  updateLiveDisplay: function(ratios) {
    ...
    ratios.forEach(r => {
      const color = r.ratio >= 4.5 ? "#00ff88" : (r.ratio >= 3 ? "#ffcc00" : "#ff6666");
